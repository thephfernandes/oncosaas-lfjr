Pitch Deck - Centelha Espírito Santo
...
OncoSaas
Plataforma de Otimização Oncológica com Inteligência Artificial

Tagline: Transformando o cuidado oncológico através de IA e WhatsApp

Programa: Centelha Espírito Santo
Categoria: Inovação Tecnológica em Saúde

---

Slide 2: O Problema

Crise na Oncologia Brasileira
...
Inacessibilidade ao cuidado oncológico de qualidade para população vulnerável
Desperdício de recursos públicos
Sobrecarga do SUS
Impacto ambiental de deslocamentos desnecessários
...
Plataforma SaaS Multi-Tenant com IA

Três Pilares Tecnológicos:

1. Navegação Inteligente

Dashboard centralizado rastreando pacientes em tempo real
Visibilidade completa da jornada oncológica
Coordenação automática entre especialidades
...
Coleta dados via WhatsApp Business API
Processamento de texto e áudio (STT)
Detecção automática de sintomas críticos
Alertas em tempo real para equipe

Diferencial: WhatsApp nativo (sem necessidade de app), IA especializada em oncologia, integração com EHRs existentes
...
HL7/FHIR (interoperabilidade com EHRs)
WhatsApp Business API (oficial)

Segurança:

Criptografia AES-256
Compliance LGPD e ANVISA (SaMD)
...
Única solução oncológica usando canal preferido
Sem necessidade de app adicional
Acessibilidade para população vulnerável

2. Agente IA Especializado

LLM com RAG em conhecimento médico oncológico
Processa texto e áudio
Detecta sintomas críticos automaticamente
Guidelines NCCN e ASCO integradas
...
Barreiras de Replicação:

Expertise em IA médica oncológica
Integração HL7/FHIR complexa
Compliance LGPD/ANVISA desde o início
Relacionamento com hospitais

Propriedade Intelectual:

Registro de software em processo
Patente de algoritmo de priorização em processo

---

Slide 6: Impacto Socioambiental

Contribuição para Saúde e Bem-Estar

Redução de Tempos (esperada):

Até 40% de redução esperada no tempo de procura de assistência
Até 30% de redução esperada no tempo de diagnóstico (60-90 → 42-63 dias)
Redução esperada no tempo de tratamento
Melhora esperada no prognóstico e aumento de chances de cura

Redução de Gastos (projetada):

15-20% de redução esperada em gastos quimioterápicos
Economia estimada de R$ 300k-500k/hospital/ano
Melhor utilização de equipamentos

Bem-Estar do Paciente:

Acesso facilitado via WhatsApp
Até 40% de redução esperada em deslocamentos
Detecção precoce de complicações
Cuidado coordenado
...
Até 40% de redução esperada em ligações manuais
Dados estruturados
20-30% de redução esperada em readmissões

Produtividade do Cidadão:

Menos tempo em deslocamentos e esperas
...
Taxa de resposta ao agente: meta ≥60%
Detecção de sintomas críticos: meta ≥90%
Redução de readmissões: meta 20-30%
Satisfação (NPS): meta ≥50
...
Resultados Esperados (projeções):

Até 30% de redução esperada em tempo de diagnóstico
20-30% de redução esperada em readmissões
Até 40% de redução esperada em ligações telefônicas
...
Unit Economics (projeções):

CAC projetado: R$ 15.000 (ciclo 3-6 meses)
LTV projetado: R$ 180.000 (3 anos, cliente médio)
LTV:CAC projetado: 12:1
Churn projetado: 5-10% ao ano (baseado em benchmarks de SaaS B2B em saúde)

Escalabilidade:

Arquitetura multi-tenant permite crescimento sem custos proporcionais
Custos variáveis estimados: ~R$ 13-20/paciente/mês (WhatsApp + APIs IA)

ROI para Clientes (projeções):

ROI projetado: 5-10x o investimento em 1 ano
Payback projetado: 2-3 meses
Economia estimada: R$ 1M-2M/ano (hospital médio)

---

Slide 10: Equipe

Por que somos as pessoas certas?

Luiz Fiorim — Fundador e CEO

- Estudante de Medicina (UFES, 4º ano - 2020-2027): Conhecimento profundo em oncologia e experiência direta no sistema de saúde brasileiro
- Desenvolvedor de agentes de IA: Projeto FgtsAgent (fase final) - agente de IA integrado ao WhatsApp Business API
- Gestor de Performance (Turbo Partners, 2022-2023): Foco em otimização de processos e ROI mensurável
- Especialista em análise de mercado, viabilidade econômica e modelagem de negócios SaaS

Pedro Fernandes — CTO

- Engenheiro de Computação (TU Delft, Holanda, 2018-2021)
- Engenheiro Full-stack Sênior (Upwork, EUA): Sistemas com >99,9% uptime, 100M+ registros, lançamentos +$5M/ano
- Líder Técnico (Turbo Partners): App Shopify para clientes internacionais, gestão de equipe
- Especialista em arquitetura escalável, sistemas multi-tenant, SaaS B2B
- Stack: JavaScript, Python, React, Docker, Kubernetes, AWS, Postgres

Gabriel Pandolfi Correa dos Santos — Cientista de Dados

- Cientista da Computação (UFSCar, 2019-2025)
- Cientista de Dados JR no Bradesco (atual): PLN com análise de sentimentos, automação de fluxos financeiros com LLMs, modelagem em Databricks
- Cientista de Dados JR na RD Saúde/Raia Drogasil (2023-2024): Modelos de ML, séries temporais, forecasting, econometria aplicada a pricing
- Projetos: Combate de Preços do Concorrente, Sugestão de melhor dia para entrega (modelos probabilísticos)
- Stack: Python, SQL, Machine Learning, NLP, Databricks, PowerBI, AWS

Combinação Única:

- Conhecimento médico avançado (Luiz) + excelência técnica em sistemas escaláveis e IA (Pedro) + expertise em Machine Learning e Análise de Dados (Gabriel) + experiência em gestão orientada a resultados (todos)
- Experiência comprovada: FgtsAgent (WhatsApp + IA), sistemas com >99,9% uptime, modelos de ML em produção
- Paixão por inovar em saúde e comprometimento com impacto social em saúde pública
...
Nenhuma solução oferece combinação integrada:

- Navegação + Priorização IA + WhatsApp
  Mercado carece de solução especializada em oncologia com IA conversacional

Nosso Diferencial:

1. IA Conversacional no WhatsApp (único no mercado)
2. Priorização Inteligente (não manual)
3. Foco em Oncologia (especializado)
4. Integração com EHRs existentes
5. Acompanhamento Remoto (coleta contínua)
...
Mitigação: Consultoria desde o início, validação jurídica, certificações
...
Risco 6: Adoção lenta do mercado

Mitigação: Pilotos com hospitais parceiros, ROI comprovado, referências
...
Redução esperada de 30% em readmissões
Redução esperada de 40% em tempo de diagnóstico
Melhoria esperada de 25% em satisfação do paciente
Economia estimada de R$ 500M+ em custos evitáveis

---

Slide 15: Call to Action

Junte-se a Nós na Transformação da Oncologia
...
Apoio do Centelha Espírito Santo
...
Tempo Recomendado: 10-15 minutos + Q&A

Slides Principais (Foco):

1. Problema (2 min) - Enfatizar crise e impacto socioambiental
2. Solução (2 min) - Destacar inovação tecnológica
3. Tecnologia (2 min) - Stack e diferenciais técnicos
4. Impacto Socioambiental (2 min) - Benefícios quantificáveis
5. Mercado (1 min) - Oportunidade de mercado
6. Validação (1 min) - Tração e pilotos
7. Equipe (1 min) - Por que somos as pessoas certas
8. Roadmap (1 min) - Próximos passos
9. Call to Action (1 min) - Próximos passos

Dicas:

Usar dados e números concretos
Focar em inovação tecnológica (prioridade do Centelha)
Destacar impacto socioambiental mensurável
Enfatizar diferenciais únicos (WhatsApp, IA especializada)
Ser transparente sobre riscos e mitigações
Mostrar capacidade de execução (projeto FgtsAgent)

---

Versão para PDF

Este documento pode ser convertido para PDF ou slides usando:

Markdown to PDF: Pandoc, Markdown PDF, ou ferramentas online
Markdown to Slides: Marp, Reveal.js, ou Slidev
Design: Adicionar logo, cores da marca, e elementos visuais

Recomendação: Usar ferramenta de apresentação (PowerPoint, Google Slides, Canva) para criar versão visual profissional com:
