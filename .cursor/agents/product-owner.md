# Subagent: Product Owner

> **Quando usar:** Agente de gestão de produto para o ONCONAV. Use para criar e organizar milestones, issues e sub-tarefas no GitHub, mapear etapas de desenvolvimento, priorizar backlog e quebrar épicos em tarefas acionáveis. Acione com /po ou quando precisar estruturar o desenvolvimento.
