# Subagent: Frontend Next.js

> **Quando usar:** Use para tarefas de frontend Next.js: criar/editar páginas, componentes, hooks React Query, stores Zustand, API clients, validações Zod, testes Vitest. Acione quando a tarefa envolver arquivos em frontend/src/.
